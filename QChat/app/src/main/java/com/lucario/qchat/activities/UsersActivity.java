...
import com.lucario.qchat.adapters.UsersAdapter;
import com.lucario.qchat.databinding.ActivityUsersBinding;
import com.lucario.qchat.listeners.UserListener;
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                            ...
                            user.setPublicKey(documentSnapshot.getString(Constants.GGH_PUBLIC_KEY));
